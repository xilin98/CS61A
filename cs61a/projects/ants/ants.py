    ...
    def remove_insect(self, insect):
        ...
        if insect.is_ant:
            ...
            # Special handling for container ants
                ...
                # Bodyguard was # TEMP:removed. Contained ant should remain in the game
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        if self.place.bees:
            ...
            return nearest_bee(self.place.entrance,hive)
        """
        # My second solution:
        temp=self.place
        n=0
        while  temp!=hive:
            if n<self.min_range or n>self.max_range:
                temp=temp.entrance
            elif temp.bees:                           # When I replace elif by if the below wrong messege I don't understand
                return random_or_none(temp.bees)    # I figure it out !!! because the entrance of hive is None
            else:                                   # Hah, this is a interesting mistake
                temp=temp.entrance
            n+=1
        return None
        # END Problem 3 and 4
        ...
        #File "C:\Users\orange\desktop\cs61a\cs61a\projects\ants\ants.py", line 250, in action
        #self.throw_at(self.nearest_bee(colony.hive))
        #File "C:\Users\orange\desktop\cs61a\cs61a\projects\ants\ants.py", line 235, in nearest_bee
        #if temp.bees:
        #AttributeError: 'NoneType' object has no attribute 'bees'
...
class HungryAnt(Ant):
    ...
    def action(self, colony):
        ...
        if self.digesting<=0 and bee: # I don't know why can't replace bee!=None by not bee
            self.eat_bee(bee)         # I understand it now ,it can replace by bee Hah..
...
class TankAnt(BodyguardAnt):
    ...
    food_cost=6
    armor=2
    # OVERRIDE CLA4uSS ATTRIBUTES HERE
    # BEGIN Problem 10
    ...
    def action(self, colony):
        # BEGIN Problem 10
        "*** YOUR CODE HERE ***"
        super().action(colony)  # Can replaced by BodyguardAnt(self,colony)
        for bee in self.place.bees[:]:
            bee.reduce_armor(self.damage)
        # END Problem 10
...
# END Problem 13
    ...
    def __init__(self, armor=1):
        ...
        "*** YOUR CODE HERE ***"
        self.armor=1
        if not QueenAnt.impostor:       # The first instantiating of AntQueen
            self.impostor=False
            ...
            while temp:
                if  temp.ant:
                    if temp.ant.is_container:
                        if temp.ant.contained_ant:
                            if temp.ant.contained_ant.buffed==False:
                                temp.ant.contained_ant.damage*=2
                                temp.ant.contained_ant.buffed=True
                    if temp.ant.buffed==False:
                        temp.ant.damage*=2
                        temp.ant.buffed=True
                temp=temp.exit
        # END Problem 13
